...
3) Access the `workbench` named `audio-to-text-u1743765545727-notebook`.
...
5) In the terminal, run `cd audio-to-text-u1743765545727` to navigate to your sample app's directory.
